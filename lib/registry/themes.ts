export const themes = [
  {
    ...
    cssVars: {
      ...
      dark: {
        ...
        card: "0 0% 6.7%", // Slightly lighter than background
        ...
        muted: "0 0% 10%",
        "muted-foreground": "0 0% 50%", // Medium gray text
        accent: "0 0% 10%",
        "accent-foreground": "0 0% 90%",
        destructive: "0 84.2% 60.2%", // Keep as is or adjust if needed
        "destructive-foreground": "0 0% 98%",
        border: "0 0% 20%", // Subtle borders
        input: "0 0% 6.7%", // Match card background
        ring: "0 0% 20%", // Slightly more visible ring
        radius: "0.5rem", // Keep radius as is
      },
    },
  },
  {
  ...
  },
  {
    ...
    cssVars: {
      ...
      dark: {
        background: "20 14.3% 8%",
        foreground: "60 9.1% 90%",
        card: "20 14.3% 12%",
        "card-foreground": "60 9.1% 90%",
        popover: "20 14.3% 4.1%",
        "popover-foreground": "60 9.1% 97.8%",
